...
class Account(Base):
    ...
    def get_positions(self, account='all'):
        ...
        for position in self._key:
            ...
            new_position = Position(quantity=quantity, symbol=position['instrument']['symbol'],
                                    type=position['instrument']['assetType'], underlying=underlying, option_type=option_type)
