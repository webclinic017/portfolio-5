...
class Base():
    ...
    def __init__(self, **kwargs):
        ...
        self.config = {'consumer_id': CONSUMER_ID,
    ...
    def _api_response(self, url, params, verify=True):
        response = requests.get(url=url, headers=self.merged_headers, params=params, verify=verify)
        ...
        try:
            response_dict['error']  # see if there is a fault message in the API response
